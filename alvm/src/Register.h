...
namespace rlang::alvm {
    ...
    public:
        inline std::uintptr_t& operator[](const std::size_t index)
        {
            return m_Buffer[index];
        }
        inline std::uintptr_t& operator[](const RegType reg)
        {
            return m_Buffer[(std::size_t)reg];
        }
        inline std::uintptr_t& operator[](const Register reg)
        {
            return m_Buffer[(std::size_t)reg.type];
        }
    };
} // namespace rlang::alvm
